<div class="card shadow ml-3 mr-3">
    ...
    <?= form_open_multipart('admin/prosesedit'); ?>
    ...
    <div class="row mb-3 ml-3">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="nip" name='nip' value='<?= $edit['nip']; ?>'>
        </div>
    </div>
    <div class="row mb-3 ml-3">
    ...
    <div class="row mb-3 ml-3">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="jabatan" name="jabatan" value='<?= $edit['jabatan']; ?>'>
    ...
    <div class="row mb-3 ml-3">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="satker" name="satker" value='<?= $edit['satker']; ?>'>
    ...
    <div class="row mb-3 ml-3">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="golongan" name="golongan" value='<?= $edit['golongan']; ?>'>
